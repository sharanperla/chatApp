...
export const create=mutation({
    ...
    handler:async (ctx,args)=>{
            ...
            {
                throw new ConvexError("You are alreday friend with this user")
            }
...
export const deny=mutation({
    ...
    handler:async (ctx,args)=>{
            ...
            {
                throw new ConvexError("There was an error in denying this request")
            }
...
export const accept=mutation({
    ...
    handler:async (ctx,args)=>{
            ...
            if(!request || request.receiver!==currentUser._id)
            {
                throw new ConvexError("There was an error in accepting this request")
            }
